...
const menuItems = [
    { texto: 'Vagas',            icone: <WorkIcon/>,      rota: '/vagas' },
    { texto: 'Serviços',         icone: <BuildIcon/>,     rota: '/srv' },
    { texto: 'Meu Perfil',       icone: <PersonIcon/>,    rota: '/perfil' },
    { texto: 'Oferecer Serviço', icone: <AddCircleIcon/>, rota: '/oferecer' },
]
