      ...
      <div className="oferecer-page">
        <div className="cadastro-servico-container">
          <header className="cadastro-servico-header">
            ...
            <p>Divulgue seu serviço e conecte-se com empresas.</p>
          </header>
            ...
            <section className="cadastro-servico-card">
              ...
              <div className="field" style={{ marginTop: 14 }}>
                ...
                <textarea
                  ...
                  placeholder="Descreva detalhadamente o que você oferece, sua metodologia e diferenciais... e informar email de contato"
                  rows={6}
                  required
                />
              </div>
